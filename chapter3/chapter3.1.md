...
> 팁 : cr은 Consistent Read(논리적 읽기), pr은 Physical Read(물리적 디스크 읽기)를 의미합니다. 이 두 숫자가 클수록 SQL이 "무겁다"고 판단하시면 돼요!


1. 블록 I/O 계산
	- 전체 논리적 I/O (Query): 총 266,968 블록
	- 인덱스 스캔 I/O : INDEX RANGE SCAN 단계에서 발생한 1,011 블록
	- 테이블 랜덤 액세스 I/O : 전체 I/O - 인덱스 I/O
		- 266,968 - 1,011 = 265,957 블록
